module.exports = {
  ...
  purchase: { en: 'Purchase for {1} {2} from {3} in {4} (x: {5}, y: {6}).' },
  ...
  beastTribe: { en: 'Achieve {1} reputation with the {2} Beast Tribe, then purchase for {3} {4} from {5} in {6} (x: {7}, y: {8}).' },
  // Achieve gold rating in the FATE '' (lv. 50), found in ... (x: , y: ).
  fate: { en: 'Achieve gold rating in the FATE \'{1}\' (lv. {2}), found in {3} (x: {4}, y: {5}).' },
  // Complete all FATEs in the '' series with a gold rating, starting from '' (lv. 30) (x: 1, y: 1).
  fateSeries: { en: 'Complete all FATEs in the \'{1}\' series with a gold rating, starting from \'\' (lv. 30) (x: 1, y: 1).' },
  ...
  premium: { en: 'Purchase {1} from the {2} and redeem the promotional code on or before {3}.' },
  // Faded material purchased for 1,000 Allagan Tomestones of Poetics from Auriana in Mor Dhona (x11, y11).
  fadedPurchase: { en: 'Faded material purchased for {1} {2} from {3} in {4} (x: {5}, y: {6}).' },
